...
К примеру, при создании кошелька в приложении [bonepayment wallet](https://bonepayment.com), пользователь получает единый приватный ключ для 5 видов криптовалют:
