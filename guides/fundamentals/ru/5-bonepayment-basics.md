...
> **Примечание: Приложение [B ONE PAYMENT Wallet](https://B ONE PAYMENT.com) было разработано компанией [B ONE PAYMENT](https://B ONE PAYMENT.com), которой принадлежит авторство данных руководств.**
