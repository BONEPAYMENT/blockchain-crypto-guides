...
Par exemple, lors de la création du portefeuille avec [B ONE PAYMENT wallet](https://bonepayment.com) l'utilisateur obtient une seule clé privée pour 5 crypto-monnaies:
